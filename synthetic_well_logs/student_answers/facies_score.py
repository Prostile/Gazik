...
from synthetic_well_logs.student_answers.schema import FaciesInterval
from synthetic_well_logs.student_answers.truth_adapter import TruthData


def score_facies(predicted: list[FaciesInterval], truth: TruthData) -> dict[str, Any]:
    ...
    for interval in predicted:
        ...
        labels[mask] = interval.facies
    expected = truth.facies.astype(str)
    ...
    targeted = {
        ("shaly_sandstone", "siltstone"),
        ("siltstone", "shaly_sandstone"),
        ("coal", "clean_sandstone"),
        ("coal", "shaly_sandstone"),
        ("anhydrite", "limestone"),
        ("anhydrite", "dolomite"),
        ("tight_sandstone", "clean_sandstone"),
        ("clean_sandstone", "tight_sandstone"),
        ("marl", "limestone"),
    }
    major_confusions = [
    ...
    return {
        "task": "facies_intervals",
        "facies_accuracy_by_depth": accuracy,
        "macro_f1": macro_f1,
